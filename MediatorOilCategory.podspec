...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of MediatorOilCategory.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/2540942304@qq.com/MediatorOilCategory'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '2540942304@qq.com' => '2540942304@qq.com' }
  s.source           = { :git => 'https://github.com/2540942304@qq.com/MediatorOilCategory.git', :tag => s.version.to_s }
